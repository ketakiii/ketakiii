...
- Building intelligent systems using retrieval and large language models
- End-to-end ML pipelines with modern MLOps tools and cloud infrastructure
- Real-world deployment of LLM-based workflows for insight extraction and automation
...
- **RAG Assistant for Product Discovery**  
  Hybrid retrievers + visual search + multimodal LLM interaction
  
---

## My Latest Blog Posts
- [LLMs as Operating Systems? MemGPT Decoded.](https://medium.com/@ketaki.kolhatkar99/llms-as-operating-systems-memgpt-decoded-70cb97e7cde5)
- [Building Trust with Machines: Defeating Nondeterminism in LLM Inference](https://medium.com/@ketaki.kolhatkar99/building-trust-with-machines-defeating-nondeterminism-in-llm-inference-b01fef416d87)
